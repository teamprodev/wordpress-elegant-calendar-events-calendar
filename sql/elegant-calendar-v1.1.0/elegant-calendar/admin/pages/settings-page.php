<?php
/**
 * Elegant_Calendar_Settings_Page Class
 *
 * @since  1.0.0
...
if ( ! class_exists( 'Elegant_Calendar_Settings_Page' ) ) :

    class Elegant_Calendar_Settings_Page extends Elegant_Calendar_Admin_Page {
        ...
        public function enqueue_scripts( $hook ) {
            ...
            elegant_calendar_admin_enqueue_scripts_settings(
